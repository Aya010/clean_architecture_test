import os
from test.entities.test_josephus import Josephus
from test.user_cases.test_user_read import UsedReader as Reader
from test.user_cases.test_qt_ui import QtUi
